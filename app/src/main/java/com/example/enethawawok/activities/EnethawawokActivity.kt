...
import com.example.enethawawok.activities.EnethawawokCallback
...
class EnethawawokActivity : AppCompatActivity(), EnethawawokCallback {
                ...
                when (tab) {
                    profileTab -> {
                        if (profileFragment == null) {
                            ...
                            profileFragment!!.setCallback(this@EnethawawokActivity)
                        }
                    ...
                    swipeTab -> {
                        if (swipeFragment == null) {
                            ...
                            swipeFragment!!.setCallback(this@EnethawawokActivity)
                        }
                    ...
                    matchesTab -> {
                        if (matchesFragment == null) {
                            ...
                            matchesFragment!!.setCallback(this@EnethawawokActivity)
                        }
    ...
    companion object {
        fun newIntent(context: Context?) = Intent(
            context,
            EnethawawokActivity::class.java
        )
    }
}
